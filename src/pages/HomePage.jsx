                ...
                <div className="container">
                    ...
                    <div className="categories-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))" }}>
                        ...
                        <div className="glass-card" style={{ textAlign: "center" }}>
                            ...
                            <h4>Chọn ứng viên</h4>
                            <p style={{ fontSize: "0.875rem" }}>Chọn 1 hoặc nhiều hạng mục bạn muốn dự đoán</p>
                        </div>
                        <div className="glass-card" style={{ textAlign: "center" }}>
                            <div style={{ fontSize: "2.5rem", marginBottom: "1rem" }}>3️⃣</div>
                            <h4>Xác nhận</h4>
                            <p style={{ fontSize: "0.875rem" }}>Mỗi hạng mục dự đoán = <strong style={{ color: "var(--gold)" }}>5.000 VND</strong></p>
                        </div>
                        <div className="glass-card" style={{ textAlign: "center" }}>
                            <div style={{ fontSize: "2.5rem", marginBottom: "1rem" }}>4️⃣</div>
                            <h4>Theo dõi</h4>
                            <p style={{ fontSize: "0.875rem" }}>Xem lịch sử và dự đoán nhiều lần để tăng cơ hội!</p>
                        </div>
                    </div>
                </div>
            </section>
